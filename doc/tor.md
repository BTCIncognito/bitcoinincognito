...
```
./btcid -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:888
```
...
HiddenServicePort 989 127.0.0.1:7250
...
your btcid's P2P listen port (7250 by default).
```
...
```
./btcid -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:888 -listen
```
...
and open port 7250 on your firewall (or use -upnp).

If you only want to use Tor to reach onion addresses, but not use it as a proxy
for normal IPv4/IPv6 communication, use:
```
./btcid -onion=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:888 -discover
```
