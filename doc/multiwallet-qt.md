...
In order to support loading of multiple wallets in btci-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is btci.cpp.
...
Changes to btci.cpp
----------------------
btci.cpp is the entry point into btci-qt, and as such, will require some minor modifications to provide hooks for
