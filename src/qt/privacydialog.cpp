                                                          ...
                                                          currentBalance(-1)
{
    ...
    ui->zBTCipayAmount->setValidator( new QDoubleValidator(0.0, 21000000.0, 20, this) );
...
void PrivacyDialog::sendzBTCi()
{
    ...
    if (!ZBTCiControlDialog::listSelectedMints.empty()) {
        vMintsSelected = ZBTCiControlDialog::GetSelectedMints();
    }
    ...
    ZBTCiControlDialog::listSelectedMints.clear();
