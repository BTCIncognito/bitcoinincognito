...
std::list<std::string> ZBTCiControlDialog::listSelectedMints;
std::list<CZerocoinMint> ZBTCiControlDialog::listMints;
...
void ZBTCiControlDialog::updateLabels()
{
    ...
    privacyDialog->setZBTCiControlLabels(nAmount, listSelectedMints.size());
}

std::vector<CZerocoinMint> ZBTCiControlDialog::GetSelectedMints()
{
