...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBTCi"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BTCi Core help message to get a list with possible BTCi command-line options"));
...
/** Creates context menu, its actions, and btcis up all the relevant signals for mouse events. */
